...
document.addEventListener('DOMContentLoaded', function() {
    ...
    fetch('footer.html')
        ...
        .then(data => {
            ...
            // Load and initialize language system after footer loads
            loadLanguageScripts().then(() => {
    ...
    return new Promise((resolve) => {
        ...
        translationsScript.onload = function() {
            ...
            languageScript.onerror = function() {
                console.error('Error loading language.js');
                resolve(); // Resolve anyway to not block
            };
            document.head.appendChild(languageScript);
        };
        translationsScript.onerror = function() {
            console.error('Error loading translations.js');
            resolve(); // Resolve anyway to not block
        };
